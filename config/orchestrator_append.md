...
### 团队交接（README Current State）
"要下线了"、"更新 Current State"、"交接"、"handoff"、"更新 README 状态"
→ 问用户三件事：
   1. 当前 sprint / 这轮做了什么
   2. 阻塞在哪（没有就说 none）
   3. 接手者下一步做什么
→ 更新 README.md 的 `## Current State (YYYY-MM-DD)` 节
→ git add + commit -m "docs: update current state" + push
